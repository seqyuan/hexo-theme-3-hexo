hexo-theme-3-hexo
================
3-hexo 是为 [anno-sc](https://anno-sc.github.io/) 制作的主题。三段式设计、方便。
...
## 安装
```bash
git clone https://github.com/seqyuan/hexo-theme-3-hexo.git themes/3-hexo
```
...
## 效果博客
- [anno-sc](https://anno-sc.github.io/)
